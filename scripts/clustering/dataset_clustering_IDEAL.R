...
dir.create("data/results/clustering_IDEAL", recursive = TRUE, showWarnings = FALSE)
...
# Save as CSV
write.csv(characteristics_df, "data/results/clustering_IDEAL/characteristics.csv", row.names = FALSE)
...
write.csv(test_data_df, "data/results/clustering_IDEAL/test_data.csv", row.names = FALSE)
...
# Save as CSV
write.csv(clusters_scaled, "data/results/clustering_IDEAL/cl_scaled.csv", row.names = FALSE)
...
write.csv(dmatrix_csv, "data/results/clustering_IDEAL/dmatrix.csv")
...
# Save as CSV
write.csv(train_set, "data/results/clustering_IDEAL/train_set.csv", row.names = FALSE)
write.csv(test_set, "data/results/clustering_IDEAL/test_set.csv", row.names = FALSE)
...
write.csv(train_dmatrix_csv, "data/results/clustering_IDEAL/train_dmatrix.csv")
...
write.csv(centroids, "data/results/clustering_IDEAL/centroids.csv", row.names = FALSE)
...
write.csv(kcca_info, "data/results/clustering_IDEAL/kcca_info.csv", row.names = FALSE)
...
write.csv(groups_df, "data/results/clustering_IDEAL/groups.csv", row.names = FALSE)

cat("\n=== CLUSTERING ANALYSIS COMPLETE ===\n")
cat("data saved:\n")
cat("  - data/results/clustering_IDEAL/characteristics.csv\n")
cat("  - data/results/clustering_IDEAL/test_data.csv\n")
cat("  - data/results/clustering_IDEAL/cl_scaled.csv\n")
cat("  - data/results/clustering_IDEAL/dmatrix.csv\n")
cat("  - data/results/clustering_IDEAL/train_set.csv\n")
cat("  - data/results/clustering_IDEAL/test_set.csv\n")
cat("  - data/results/clustering_IDEAL/train_dmatrix.csv\n")
cat("  - data/results/clustering_IDEAL/centroids.csv\n")
cat("  - data/results/clustering_IDEAL/kcca_info.csv\n")
cat("  - data/results/clustering_IDEAL/groups.csv\n")
