...
arguments=("monks-problems-2")
# "mfeat-pixel" "monks-problems-2" "steel-plates-fault" "vehicle" "wall-robot-navigation"
arguments2=("fda")
# "C5.0" "ctree" "fda" "gbm" "gcvEarth" "JRip" "lvq" "mlpML" "multinom" "naive_bayes" "PART" "rbfDDA" "rda" "rf" "rpart" "simpls" "svmLinear" "svmRadial" "rfRules" "knn" "bayesglm"
